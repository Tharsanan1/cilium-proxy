...
import (
	...
	alf "github.com/cilium/proxy/go/envoy/config/accesslog/v3"
	cluster "github.com/cilium/proxy/go/envoy/config/cluster/v3"
	core "github.com/cilium/proxy/go/envoy/config/core/v3"
	endpoint "github.com/cilium/proxy/go/envoy/config/endpoint/v3"
	listener "github.com/cilium/proxy/go/envoy/config/listener/v3"
	route "github.com/cilium/proxy/go/envoy/config/route/v3"
	als "github.com/cilium/proxy/go/envoy/extensions/access_loggers/grpc/v3"
	router "github.com/cilium/proxy/go/envoy/extensions/filters/http/router/v3"
	hcm "github.com/cilium/proxy/go/envoy/extensions/filters/network/http_connection_manager/v3"
	tcp "github.com/cilium/proxy/go/envoy/extensions/filters/network/tcp_proxy/v3"
	auth "github.com/cilium/proxy/go/envoy/extensions/transport_sockets/tls/v3"
	runtime "github.com/cilium/proxy/go/envoy/service/runtime/v3"
