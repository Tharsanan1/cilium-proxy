...
import (
	...
	conf "github.com/cilium/proxy/go/pkg/server/config"
	"github.com/cilium/proxy/go/pkg/server/sotw/v3"
	"github.com/cilium/proxy/go/pkg/server/v3"
	"github.com/cilium/proxy/go/pkg/test"
	"github.com/cilium/proxy/go/pkg/test/resource/v3"
	testv3 "github.com/cilium/proxy/go/pkg/test/v3"
)
